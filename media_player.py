"""Support for interfacing with Monoprice 31028 6 zone home audio controller."""
import logging
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    """Set up the Monoprice 6-zone (31028) amplifier platform."""
...
class MonopriceZone(MediaPlayerDevice):
    """Representation of a Monoprice 31028 amplifier zone."""
    ...
    def update(self):
        ...
        try:
            ...
            _LOGGER.warning(SerialException)
